var Vue = function(e) {
	...
	class fe {
		...
		run() {
			...
			try {
				...
				})(this), ce = 1 << --le, ae = this.parent, he = t, this.parent = void 0
			}
		}
		stop() {
	...
	const xe = t("__proto__,__v_isRef,__isVue"),
		Ce = new Set(Object.getOwnPropertyNames(Symbol).map((e => Symbol[e])).filter(F)),
		we = Oe(),
		ke = Oe(!1, !0),
		Te = Oe(!0),
		Ne = Oe(!0, !0),
	...
	function Vt(e, t, n) {
		return A(t) ? (t = JSON.stringify(t), n ? t : [`${e}=${t}`]) : "number" == typeof t || "boolean" == typeof t || null == t ? n ? t : [`${e}=${t}`] : Ct(t) ? (t = Vt(e, vt(t.value), !0), n ? t : [`${e}=Ref<`, t, ">"]) : R(t) ? [`${e}=fn${t.name?`<${t.name}>`:""}`] : (t = vt(t), n ? t : [`${e}=`, t])
	}
	...
	function en(e) {
		Ht.length && Ht.includes(e, jt && e.allowRecurse ? Dt + 1 : Dt) || e === Qt || (null == e.id ? Ht.push(e) : Ht.splice(function(e) {
			let t = Dt + 1,
				n = Ht.length;
			for (; t < n;) {
				const o = t + n >>> 1;
	...
	function vn(e) {
		...
		try {
			if (4 & n.shapeFlag) {
				...
				const e = t;
				0, g = Ar(e(s, e.length > 1 ? {
					attrs: c,
					slots: l,
					emit: a
				} : null)), v = t.props ? c : yn(c)
			}
		} catch (_) {
	...
	const xn = {
		...
		process(e, t, n, o, r, s, i, l, c, a) {
			null == e ? function(e, t, n, o, r, s, i, l, c) {
				...
				} = c, p = u("div"), f = e.suspense = wn(e, r, o, t, p, n, s, i, l, c);
				a(null, f.pendingBranch = e.ssContent, p, null, o, f, s, i), f.deps > 0 ? (Cn(e, "onPending"), Cn(e, "onFallback"), a(null, e.ssFallback, t, n, o, null, s, i), Nn(f, e.ssFallback)) : f.resolve()
				...
				if (m) p.pendingBranch = f, Cr(f, m) ? (c(m, f, p.hiddenContainer, null, r, p, s, i, l), p.deps <= 0 ? p.resolve() : g && (c(h, d, n, o, r, null, s, i, l), Nn(p, d))) : (p.pendingId++, v ? (p.isHydrating = !1, p.activeBranch = m) : a(m, r, p), p.deps = 0, p.effects.length = 0, p.hiddenContainer = u("div"), g ? (c(null, f, p.hiddenContainer, null, r, p, s, i, l), p.deps <= 0 ? p.resolve() : (c(h, d, n, o, r, null, s, i, l), Nn(p, d))) : h && Cr(f, h) ? (c(h, f, n, o, r, p, s, i, l), p.resolve(!0)) : (c(null, f, p.hiddenContainer, null, r, p, s, i, l), p.deps <= 0 && p.resolve()));
				else if (h && Cr(f, h)) c(h, f, n, o, r, p, s, i, l), Nn(p, f);
				else if (Cn(t, "onPending"), p.pendingBranch = f, p.pendingId++, c(null, f, p.hiddenContainer, null, r, p, s, i, l), p.deps <= 0) p.resolve();
				else {
					const {
						timeout: e,
						pendingId: t
	...
	function Fn(e, t, {
		...
		let i, l, c = !1,
			a = !1;
		if (Ct(e) ? (i = () => e.value, c = mt(e)) : dt(e) ? (i = () => e, o = !0) : N(e) ? (a = !0, c = e.some(dt), i = () => e.map((e => Ct(e) ? e.value : dt(e) ? Vn(e) : R(e) ? It(e, s, 2) : void 0))) : i = R(e) ? t ? () => It(e, s, 2) : () => {
		...
		let d;
		f.allowRecurse = !!t, d = "sync" === r ? f : "post" === r ? () => Jo(f, s && s.suspense) : () => {
			!s || s.isMounted ? function(e) {
				nn(e, zt, Wt, Kt)
			}(f) : f()
		};
		const h = new fe(i, d);
		return t ? n ? f() : p = h.run() : "post" === r ? Jo(h.run.bind(h), s && s.suspense) : h.run(), () => {
			...
			setup(e, {
				...
				return () => {
					...
					if (f && f.type !== fr && (!Cr(a, f) || d)) {
						const e = Un(f, i, o, n);
						if (Wn(f, e), "out-in" === l) return o.isLeaving = !0, e.afterLeave = () => {
							o.isLeaving = !1, n.update()
						}, Hn(c);
						"in-out" === l && a.type !== fr && (e.delayLeave = (e, t, n) => {
							jn(o, f)[String(f.key)] = f, e._leaveCb = () => {
	...
	function Un(e, t, n, o) {
		const {
			...
			onAfterAppear: v,
			onAppearCancelled: y
		} = t, b = String(e.key), _ = jn(n, e), S = (e, t) => {
			e && Bt(e, o, 9, t)
		}, x = {
			mode: s,
			persisted: i,
		...
		Yn = {
			...
			setup(e, {
				...
				o.activate = (e, t, n, o, r) => {
					const s = e.component;
					a(e, t, n, 0, l), c(s.vnode, e, t, n, s, l, o, e.slotScopeIds, r), Jo((() => {
				...
				return lo(v), ao(v), uo((() => {
					...
					const d = null == l.key ? c : l.key,
						h = r.get(d);
					return l.el && (l = Or(l), 128 & o.shapeFlag && (o.ssContent = l)), g = d, h ? (l.el = h.el, l.component = h.component, l.transition && Wn(l, l.transition), l.shapeFlag |= 512, s.delete(d), s.add(d)) : (s.add(d), f && s.size > parseInt(f, 10) && m(s.values().next().value)), l.shapeFlag |= 256, i = l, o
				}
			}
		};
	...
	const so = e => (t, n = Wr) => (!Zr || "sp" === e) && ro(e, t, n),
		io = so("bm"),
		lo = so("m"),
		co = so("bu"),
		ao = so("u"),
	...
	function yo(e) {
		...
		if (a && function(e, t, n = y, o = !1) {
				...
				for (const r in e) {
					const n = e[r];
					let s;
					s = P(n) ? "default" in n ? $n(n.from || r, n.default, !0) : $n(n.from || r) : $n(n), Ct(s) && o ? Object.defineProperty(t, r, {
						enumerable: !0,
						configurable: !0,
						get: () => s.value,
						set: e => s.value = e
	...
	function Eo(e, t, n, o) {
		...
		if (t)
			for (let c in t) {
				...
				const a = t[c];
				let u;
				r && T(r, u = W(c)) ? s && s.includes(u) ? (i || (i = {}))[u] = a : n[u] = a : fn(e.emitsOptions, c) || c in o && a === o[c] || (o[c] = a, l = !0)
			}
		if (s) {
			const t = vt(n),
				o = i || g;
	...
	function qo(e) {
		const {
				...
				default:
					if (1 & _) x = 1 !== S || o.type.toLowerCase() !== n.tagName.toLowerCase() ? v() : u(n, o, i, l, c, m);
						...
						if (t(o, e, null, i, l, Ko(e), m), x = g ? h(n) : r(n), Gn(o)) {
							let t;
							g ? (t = Er(ur), t.anchor = x ? x.previousSibling : e.lastChild) : t = 3 === n.nodeType ? Rr("") : Er("div"), t.el = n, o.component.subTree = t
						}
					} else 64 & _ ? x = 8 !== S ? v() : o.type.hydrate(n, o, i, l, c, m, e, p) : 128 & _ && (x = o.type.hydrate(n, o, i, l, Ko(s(n)), c, m, e, a))
			}
			...
			if (h || -1 !== u) {
				...
				let c;
				if ((c = a && a.onVnodeBeforeMount) && Vr(c, n, t), d && jo(t, null, n, "beforeMount"), ((c = a && a.onVnodeMounted) || d) && Tn((() => {
	...
	function Qo(e, t) {
		...
		const {
			...
			if (e.el && void 0 !== d && -1 === b) f = e.el = d(e.el);
				...
				if (f = e.el = s(e.type, c, g && g.is, g), 8 & v ? a(f, e.children) : 16 & v && N(e.children, f, null, i, l, c && "foreignObject" !== m, u, p), _ && jo(e, null, i, "created"), g) {
			...
			S && y.beforeEnter(f), n(f, t, o), ((h = g && g.onVnodeMounted) || S || _) && Jo((() => {
			...
			m && (a = a ? a.concat(m) : m), null == e ? (n(p, o, r), n(f, o, r), N(t.children, o, f, s, l, c, a, u)) : d > 0 && 64 & d && h && e.dynamicChildren ? ($(e.dynamicChildren, h, o, s, l, c, a), (null != t.key || s && t === s.subTree) && er(e, t, !0)) : B(e, t, o, f, s, l, c, a, u)
		}, A = (e, t, n, o, r, s, i, l, c) => {
			...
			const l = e.component = function(e, t, n) {
				...
				s.ctx = {
					_: s
				}, s.root = t ? t.root : s, s.emit = un.bind(null, s), e.ce && e.ce(s);
				return s
			}(e, o, r);
			if (Jn(e) && (l.ctx.renderer = ne), function(e, t = !1) {
					Zr = t;
					const {
						props: n,
						children: o
			...
			const l = e.effect = new fe((() => {
					if (e.isMounted) {
						let t, {
							...
							p = n;
						Xo(e, !1), n ? (n.el = a.el, I(e, n, i)) : n = a, o && Y(o), (t = n.props && n.props.onVnodeBeforeUpdate) && Vr(t, c, n, a), Xo(e, !0);
						const f = vn(e),
							d = e.subTree;
						e.subTree = f, m(d, f, u(d.el), Q(d), e, r, s), n.el = f.el, null === p && Sn(e, f.el), l && Jo(l, r), (t = n.props && n.props.onVnodeUpdated) && Jo((() => Vr(t, c, n, a)), r)
					} else {
						let i;
						const {
							el: l,
			...
			e.vnode = t, e.next = null,
				function(e, t, n, o) {
					...
					} = e, l = vt(r), [c] = e.propsOptions;
					let a = !1;
					if (!(o || i > 0) || 16 & i) {
						let o;
						Eo(e, t, r, s) && (a = !0);
						for (const s in l) t && (T(t, s) || (o = K(s)) !== s && T(t, o)) || (c ? !n || void 0 === n[s] && void 0 === n[o] || (r[s] = $o(c, l, s, void 0, e, !0)) : delete r[s]);
						if (s !== l)
					...
					if (s)
						for (const l in r) Mo(l) || l in i || delete r[l]
				})(e, t.children, n), ge(), rn(void 0, e.update), ve()
			...
			if (h && (m = i && i.onVnodeBeforeUnmount) && Vr(m, t, e), 6 & u) q(e.component, n, o);
				...
				d && jo(e, null, t, "beforeUnmount"), 64 & u ? e.type.remove(e, t, n, r, ne, o) : a && (s !== ur || p > 0 && 64 & p) ? J(a, t, n, !1, !0) : (s === ur && 384 & p || !r && 16 & u) && J(c, t, n), o && z(e)
			}(h && (m = i && i.onVnodeUnmounted) || d) && Jo((() => {
			...
			o && Y(o), r.stop(), s && (s.active = !1, D(i, e, t, n)), l && Jo(l, t), Jo((() => {
				e.isUnmounted = !0
	...
	const sr = {
			...
			process(e, t, n, o, r, s, i, l, c, a) {
				...
				if (null == e) {
					...
					const o = t.anchor = e.anchor,
						...
						v = m ? n : u,
						y = m ? o : d;
					if (i = i || nr(u), b ? (f(e.dynamicChildren, b, v, r, s, i, l), er(e, t, !0)) : c || p(e, t, v, y, r, s, i, l, !1), g) m || rr(t, n, o, a, 1);
			...
			hydrate: function(e, t, n, o, r, s, {
				...
				if (u) {
					...
					16 & t.shapeFlag && (tr(t.props) ? (t.anchor = a(i(e), t, l(e), n, o, r, s), t.targetAnchor = c) : (t.anchor = i(e), t.targetAnchor = a(c, t, u, n, o, r, s)), u._lpa = t.targetAnchor && i(t.targetAnchor))
				}
	...
	function Nr(e, t = null, n = null, o = 0, r = null, s = (e === ur ? 0 : 1), i = !1, l = !1) {
		...
		return l ? (Pr(c, n), 128 & s && e.normalize(c)) : n && (c.shapeFlag |= A(n) ? 8 : 16), yr > 0 && !i && mr && (c.patchFlag > 0 || 6 & s) && 32 !== c.patchFlag && mr.push(c), c
	}
	...
	const Br = e => e ? qr(e) ? ns(e) || e.proxy : Br(e.parent) : null,
		...
		jr = {
			...
			has({
				...
				let l;
				return !!n[i] || e !== g && T(e, i) || t !== g && T(t, i) || (l = s[0]) && T(l, i) || T(o, i) || T(Lr, i) || T(r.config.globalProperties, i)
			},
	...
	function ns(e) {
		if (e.exposed) return e.exposeProxy || (e.exposeProxy = new Proxy($t(yt(e.exposed)), {
			get: (t, n) => n in t ? t[n] : n in Lr ? Lr[n](e) : void 0
		}))
	}
	const os = /(?:^|[-_])(\w)/g;
	...
	function cs(e, t, n) {
		...
		return 2 === o ? P(t) && !N(t) ? xr(t) ? Er(e, null, [t]) : Er(e, t) : Er(e, null, t) : (o > 3 ? n = Array.prototype.slice.call(arguments, 2) : 3 === o && xr(n) && (n = [n]), Er(e, t, n))
	}
	const as = Symbol("");
			...
			if (o) {
				const i = s[t] = function(e, t) {
					const n = e => {
						...
						(Ss || o >= n.attached - 1) && Bt(function(e, t) {
							if (N(t)) {
	...
	function qs(e, t) {
		...
		let u = null,
			p = 0,
			f = 0;
		t === Ps ? i > 0 && (u = Ps, p = i, f = s.length) : t === Ms ? a > 0 && (u = Ms, p = a, f = c.length) : (p = Math.max(i, a), u = p > 0 ? i > a ? Ps : Ms : null, f = u ? u === Ps ? s.length : c.length : 0);
		return {
			type: u,
			timeout: p,
			propCount: f,
	...
	function Oc(e, t, n = !1) {
		...
		s && t.transformHoist && t.transformHoist(o, t, e), s && s === r && 1 === e.type && 0 === e.tagType && e.codegenNode && 13 === e.codegenNode.type && N(e.codegenNode.children) && (e.codegenNode.children = t.hoist(xl(e.codegenNode.children)))
	}
	...
	const ea = jc("for", ((e, t, n) => {
		...
		return function(e, t, n, o) {
			...
			const s = Nl(o(Qi), [t.source]),
				...
				f = p ? 64 : c ? 128 : 256;
			return t.codegenNode = Sl(n, o(Pi), void 0, s, f + "", void 0, void 0, !0, !p, !1, e.loc), () => {
				let c;
				const {
					children: f
				} = t, d = 1 !== f.length || 1 !== f[0].type, h = ql(e) ? e : i && 1 === e.children.length && ql(e.children[0]) ? e.children[0] : null;
				if (h ? (c = h.codegenNode, i && u && Xl(c, u, n)) : d ? c = Sl(n, o(Pi), u ? Cl([u]) : void 0, e.children, "64", void 0, void 0, !0, void 0, !1) : (c = f[0].codegenNode, i && u && Xl(c, u, n), c.isBlock !== !p && (c.isBlock ? (r(Li), r(Yl(n.inSSR, c.isComponent))) : r(Jl(n.inSSR, c.isComponent))), c.isBlock = !p, c.isBlock ? (o(Li), o(Yl(n.inSSR, c.isComponent))) : o(Jl(n.inSSR, c.isComponent))), l) {
					const e = El(ia(t.parseResult, [kl("_cached")]));
					e.body = {
						type: 21,
						body: [Tl(["const _memo = (", l.exp, ")"]), Tl(["if (_cached", ...a ? [" && _cached.key === ", a] : [], ` && ${n.helperString(yl)}(_cached, _memo)) return _cached`]), Tl(["const _item = ", c]), kl("_item.memo = _memo"), kl("return _item")],
						loc: _l
	...
	function ga(e, t, n = e.props, o = !1) {
		...
		const _ = [],
			x = ({
				...
				if (Ol(e)) {
					const o = e.content,
						r = S(o);
					if (l || !r || "onclick" === o.toLowerCase() || "onUpdate:modelValue" === o || j(o) || (v = !0), r && j(o) && (b = !0), 20 === n.type || (4 === n.type || 8 === n.type) && Rc(n, t) > 0) return;
		...
		for (let S = 0; S < n.length; S++) {
			...
			if (6 === i.type) {
				...
				let s = !0;
				if ("ref" === n && (h = !0, t.scopes.vFor > 0 && c.push(wl(kl("ref_for", !0), kl("true")))), "is" === n && (ba(r) || o && o.content.startsWith("vue:"))) continue;
				...
				if (g && o) continue;
				if ((m && Wl(l, "key") || g && p && Wl(l, "vue:before-update")) && (f = !0), m && Wl(l, "ref") && t.scopes.vFor > 0 && c.push(wl(kl("ref_for", !0), kl("true"))), !l && (m || g)) {
		...
		let C;
		if (a.length ? (c.length && a.push(Cl(va(c), s)), C = a.length > 1 ? Nl(t.helper(nl), a, s) : a[0]) : c.length && (C = Cl(va(c), s)), y ? d |= 16 : (m && !l && (d |= 2), g && !l && (d |= 4), _.length && (d |= 8), v && (d |= 32)), f || 0 !== d && 32 !== d || !(h || b || u.length > 0) || (d |= 512), !t.inSSR && C) switch (C.type) {
			case 15:
				let e = -1,
					n = -1,
					o = !1;
				...
				const r = C.properties[e],
					s = C.properties[n];
				o ? C = Nl(t.helper(sl), [C]) : (r && !Ol(r.value) && (r.value = Nl(t.helper(ol), [r.value])), !s || Ol(s.value) || !g && 17 !== s.value.type || (s.value = Nl(t.helper(rl), [s.value])));
				break;
			case 14:
				break;
			default:
		...
		if (ql(e)) {
			const {
				...
				for (let s = 0; s < e.props.length; s++) {
					const t = e.props[s];
					6 === t.type ? t.value && ("name" === t.name ? o = JSON.stringify(t.value.content) : (t.name = W(t.name), r.push(t))) : "bind" === t.name && Wl(t.arg, "name") ? t.exp && (o = t.exp) : ("bind" === t.name && t.arg && Ol(t.arg) && (t.arg.content = W(t.arg.content)), r.push(t))
				}
				if (r.length > 0) {
					const {
						props: o,
	...
	const Sa = /^\s*([\w$_]+|(async\s*)?\([^)]*?\))\s*=>|^\s*(async\s+)?function(?:\s+[\w$]+)?\s*\(/,
		...
		Ca = (e, t, n) => {
			...
			return 4 !== i.type ? (i.children.unshift("("), i.children.push(') || ""')) : i.isStatic || (i.content = `${i.content} || ""`), r.includes("camel") && (4 === i.type ? i.content = i.isStatic ? W(i.content) : `${n.helperString(cl)}(${i.content})` : (i.children.unshift(`${n.helperString(cl)}(`), i.children.push(")"))), n.inSSR || (r.includes("prop") && wa(i, "."), r.includes("attr") && wa(i, "^")), !o || 4 === o.type && !o.content.trim() ? {
				props: [wl(i, kl("", !0, s))]
			} : {
				props: [wl(i, o)]
			}
	...
	return Xr(ou), e.BaseTransition = Ln, e.Comment = fr, e.EffectScope = te, e.Fragment = ur, e.KeepAlive = Yn, e.ReactiveEffect = fe, e.Static = dr, e.Suspense = xn, e.Teleport = sr, e.Text = pr, e.Transition = Vs, e.TransitionGroup = ei, e.VueElement = Rs, e.callWithAsyncErrorHandling = Bt, e.callWithErrorHandling = It, e.camelize = W, e.capitalize = G, e.cloneVNode = Or, e.compatUtils = null, e.compile = ou, e.computed = is, e.createApp = (...e) => {
	...
	}, e.createBlock = Sr, e.createCommentVNode = function(e = "", t = !1) {
		return t ? (gr(), Sr(fr, null, e)) : Er(fr, null, e)
	}, e.createElementBlock = function(e, t, n, o, r, s) {
		return _r(Nr(e, t, n, o, r, s, !0))
	}, e.createElementVNode = Nr, e.createHydrationRenderer = Zo, e.createPropsRestProxy = function(e, t) {
		const n = {};
		...
		return n
	}, e.createRenderer = Yo, e.createSSRApp = (...e) => {
	...
	}, e.createTextVNode = Rr, e.createVNode = Er, e.customRef = function(e) {
		return new Ot(e)
		...
		return Kn({
			...
			setup() {
				...
				if (i && e.suspense) return p().then((t => () => qn(t, e))).catch((e => (t(e), () => o ? Er(o, {
					error: e
				}) : null)));
				const l = wt(!1),
					u = wt(),
				...
				return r && setTimeout((() => {
					...
					t(e), u.value = e
				})), () => l.value && c ? qn(c, e) : u.value && o ? Er(o, {
					error: u.value
				}) : n && !f.value ? Er(n) : void 0
			}
		})
	}, e.defineComponent = Kn, e.defineCustomElement = $s, e.defineEmits = function() {
		return null
		...
		return n
	}, e.mergeProps = Mr, e.nextTick = Xt, e.normalizeClass = a, e.normalizeProps = function(e) {
		if (!e) return null;
		let {
			class: t,
			style: n
	...
	}, e.normalizeStyle = s, e.onActivated = Qn, e.onBeforeMount = io, e.onBeforeUnmount = uo, e.onBeforeUpdate = co, e.onDeactivated = Xn, e.onErrorCaptured = go, e.onMounted = lo, e.onRenderTracked = mo, e.onRenderTriggered = ho, e.onScopeDispose = function(e) {
		ee && ee.cleanups.push(e)
	}, e.onServerPrefetch = fo, e.onUnmounted = po, e.onUpdated = ao, e.openBlock = gr, e.popScopeId = function() {
		hn = null
	}, e.provide = En, e.proxyRefs = $t, e.pushScopeId = function(e) {
		hn = e
	}, e.queuePostFlushCb = on, e.reactive = at, e.readonly = pt, e.ref = wt, e.registerRuntimeCompiler = Xr, e.render = Ni, e.renderList = function(e, t, n, o) {
		let r;
		const s = n && n[o];
		if (N(e) || A(e)) {
		...
		if (dn.isCE) return Er("slot", "default" === t ? null : {
			name: t
		}, o && o());
		let s = e[t];
		s && s._c && (s._d = !1), gr();
	...
	}, e.resolveFilter = null, e.resolveTransitionHooks = Un, e.setBlockTracking = br, e.setDevtoolsHook = function t(n, o) {
		var r, s;
	...
	}, e.setTransitionHooks = Wn, e.shallowReactive = ut, e.shallowReadonly = function(e) {
		return ft(e, !0, Me, ot, lt)
	}, e.shallowRef = function(e) {
		return kt(e, !0)
	}, e.ssrContextKey = as, e.ssrUtils = null, e.stop = function(e) {
		e.effect.stop()
	}, e.toDisplayString = e => A(e) ? e : null == e ? "" : N(e) || P(e) && (e.toString === V || !R(e.toString)) ? JSON.stringify(e, m, 2) : String(e), e.toHandlerKey = q, e.toHandlers = function(e) {
		const t = {};
		for (const n in e) t[q(n)] = e[n];
		return t
	}, e.toRaw = vt, e.toRef = At, e.toRefs = function(e) {
		const t = N(e) ? new Array(e.length) : {};
		for (const n in e) t[n] = At(e, n);
		return t
	}, e.transformVNodeArgs = function(e) {}, e.triggerRef = function(e) {
		xt(e)
	}, e.unref = Nt, e.useAttrs = function() {
		return ls().attrs
		...
		return ls().slots
	}, e.useTransitionState = In, e.vModelCheckbox = ci, e.vModelDynamic = mi, e.vModelRadio = ui, e.vModelSelect = pi, e.vModelText = li, e.vShow = _i, e.version = ps, e.warn = function(e, ...t) {
		ge();
		...
		if (o) It(o, n, 11, [e + t.join(""), n && n.proxy, r.map((({
			vnode: e
		}) => `at <${ss(n,e.type)}>`)).join("\n"), r]);
		else {
		...
		ve()
	}, e.watch = An, e.watchEffect = function(e, t) {
		return Fn(e, null, t)
	}, e.watchPostEffect = On, e.watchSyncEffect = function(e, t) {
		return Fn(e, null, {
			flush: "sync"
		})
		...
		return e(n, ...o)
	}, e.withScopeId = e => gn, Object.defineProperty(e, "__esModule", {
		value: !0
	}), e
}({});